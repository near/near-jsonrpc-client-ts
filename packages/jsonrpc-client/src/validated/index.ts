...
// Generated at: 2025-09-12T15:29:42.871Z
// Total functions: 31
// 
...
export async function experimentalCongestionLevel(
  ...
  // Call the base function
  const result = await baseFunctions.experimentalCongestionLevel(client, params);
...
export async function experimentalLightClientBlockProof(
  ...
  // Call the base function
  const result = await baseFunctions.experimentalLightClientBlockProof(client, params);
...
export async function experimentalLightClientProof(
  ...
  // Call the base function
  const result = await baseFunctions.experimentalLightClientProof(client, params);
...
export async function experimentalSplitStorageInfo(
  ...
  // Call the base function
  const result = await baseFunctions.experimentalSplitStorageInfo(client, params);
